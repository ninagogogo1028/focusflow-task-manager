...
const FeedbackModal: React.FC<{ onClose: () => void; onSubmitted: () => void }> = ({ onClose, onSubmitted }) => {
  ...
  return <div className="fixed inset-0 z-[260] bg-slate-950/45 backdrop-blur-sm flex items-center justify-center p-4"><form name="focusflow-feedback" method="POST" action="/" data-netlify="true" onSubmit={submit} className="bg-white w-full max-w-xl rounded-[2rem] shadow-2xl p-7 md:p-9">
    <input type="hidden" name="form-name" value="focusflow-feedback" />
